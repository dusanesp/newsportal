...
INSERT INTO user (`id`, `version`, `login`, `password`, `email`, `name`) VALUES
(1, 0, 'admin', '$2a$10$MXqqS2vMDy9DAAB53udQ5Oc27OHoCXvoV.MtJZg7Lrg7kUDqxU/L.', 'admin@gmail.com', 'John'),
(2, 0, 'author', '$2a$10$RewEvCU1BRWPJPLwojKbZODmilxRuRDoVd5DmcqjT9QUrXfmgtefy', 'author@gmail.com', 'Peter'),
(3, 0, 'user', '$2a$10$7w5J60.3TQxGJZ0GGEKGEuU6bkDXWET1SGQZ1EfNE6/mdolLMDe0i', 'user@gmail.com', 'Ann');
...
(1, 0, 'Games'), (2, 0, 'Movies'), (3, 0, 'GameIndustry'), (4, 0, 'Gadgets');

-- -----------------------------------------------------
-- DUMP ARTICLES
-- -----------------------------------------------------

INSERT INTO article (`id`, `version`, `title`, `preview`, `content`, `user_id`, `category_id`) VALUES
(1, 0, 'Terminator: Genesis Starts Filming',
...
(2, 0, 'Nike Lays Off Staff, FuelBand Line`s Future In Question',
...
(3, 0, 'Minecraft to Aid Redesign Efforts Around the World',
...
(4, 0, 'Danny Boyle Eyed to Direct Steve Jobs Biopic, Possibly Starring Leonardo DiCaprio',
...
(5, 0, 'Space Case: Galactic Civilizations III is a 4X Work in Progress',
...
(6, 0, 'The Elder Scrolls Online: Review in Progress',
...
(7, 0, 'Microsoft Files `Eden Falls` Trademark',
...
INSERT INTO tag (`id`, `version`, `name`) VALUES
(1, 0, 'Terminator'), (2, 0, 'Schwarzenegger'),
(3, 0, 'Nike'), (4, 0, 'FuelBand'),
(5, 0, 'Minecraft'), (6, 0, 'PC'),
(7, 0, 'Danny Boyle'), (8, 0, 'DiCaprio'), (9, 0, 'Steve Jobs'),
(10, 0, 'GalCiv'),
(11, 0, 'MMORPG'), (12, 0, 'TES'), (13, 0, 'Online'),
(14, 0, 'Microsoft'), (15, 0, 'E3'),
(16, 0, 'Game');
