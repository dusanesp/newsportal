	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
			<%@ taglib prefix="t" tagdir="/WEB-INF/tags" %>
				...
				<c:set var="title">
					<spring:message code="signin.pageTitle" /> |
				...
				<t:template title="${title}">
					<jsp:body>
						<form name="form-s" class="form-signin" action="signin/check" method="post">
							...
							<!-- Login -->
							<input type="text" class="form-control" name="username" placeholder="<spring:message code="
								signin.username" />" autofocus>
							...
							<label class="checkbox">
								<input type="checkbox" name="_spring_security_remember_me" value="true" checked>
