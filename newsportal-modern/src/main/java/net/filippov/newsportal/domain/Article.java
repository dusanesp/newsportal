...
public class Article extends BaseEntity {
    ...
    @Column(name = "preview", nullable = false, length = 65535) // Added length explicitly just in case
    ...
    /**
     * @return image URL/path of this article
     */
    ...
    /**
     * @param imageUrl image URL/path of this article to set
     */
